...
public class ActividadSangrado2 extends Fragment implements View.OnClickListener{
    Button btnAcompañe;
    ImageButton btnVolver;
    public ActividadSangrado2() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View vistaADevolver = inflater.inflate(R.layout.fragment_actividad_sangrado2, container, false);
